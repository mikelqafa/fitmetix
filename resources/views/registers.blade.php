...
<head>
    ...
    <style>
        ...
        .overlay { position:absolute;height:890px;background:#FFF;opacity:0.45;width:100%; }
        .bose { height: 600vh; }.logos { background:none !important; }
        @media (max-width: 499px) { .overlay{ height:850px; }.bose { height: 970px;}.logos { max-height:990px;background-image:none; } }
        ...
        @media (min-width: 970px) { .navbar-brand{ margin-right: 700px; }.bose-holder img { width: 100% !important; } }
...
<div class="">
    <div class="bose">
        <nav class="navbar socialite navbar-default no-bg guest-nav">
            ...
            <div class="container" style="position: relative !important;">
                <div class="col-sm-12 col-md-6">
                    <p class="text-center">
                        <a class="socialite" href="{!! url('/') !!}">
                            <img style="margin: 700 auto;" class="img-responsive logos" src="{!! url('setting/'.$setting['logo']) !!}" alt="Fitmetix" title="Fitmetix">
                        </a>
                    </p>
                ...
                <div class="col-sm-2 col-md-6" style="padding:40px 40px;">
    ...
    <div class="col-md-2" style="margin-top: -510px;">
