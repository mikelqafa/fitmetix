...
Route::get('events', 'TimelineController@showEvents');

Route::get('paypal/{group}/{id}', array('as' => 'addmoney.paypal','uses' => 'AddMoneyController@postPaymentWithpaypal',));
Route::get('paypal/{group}/{id}', array('as' => 'payment.status','uses' => 'AddMoneyController@getPaymentStatus',));
...
Route::group(['prefix' => '/{username}', 'middleware' => 'auth'], function ($username) {
    ...
    Route::get('/reviews', 'TimelineController@displayReviews');
