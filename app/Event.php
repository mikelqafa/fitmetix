...
class Event extends Model
{
   ...
   * @var array
   */
    protected $fillable = ['timeline_id', 'type', 'user_id', 'start_date', 'end_date', 'active', 'invite_privacy', 'timeline_post_privacy','location','group_id', 'price', 'user_limit', 'gender', 'focus', 'frequency'];
    ...
    /*public function getGuestInfo($id) {
        return $this->belongsToMany('App\User', 'event_user', 'event_id', 'user_id')->where('user_id', $id);
    }*/
